...
describe("Question component",()=>{
    ...
    describe('guest',()=>{
        it("render question component - contains one reply",async ()=>{
            render(<Question question={question} user={guest1} canUploadFile={false} isAnswering={false} isModerate={false} isHost={false}/>);
            const elements = screen.getAllByText(/ReplyComponent/);
            expect(elements.length).toEqual(1);
            expect(screen.getByText('[1]')).toBeInTheDocument();
        })
        it("render question component - contains no reply",async ()=>{
            render(<Question question={{...question, replies:[]}} user={guest1} canUploadFile={false} isAnswering={false} isModerate={false} isHost={false}/>);
            // const elements = screen.getAllByText(/ReplyComponent/);
            // expect(elements.length).toEqual(0);
           expect(screen.queryByText('ReplyComponent')).not.toBeInTheDocument();
        })
        it("render question component - not questioner, no edit button, not isAnswering",async ()=>{
            render(<Question question={question} user={guest1} canUploadFile={false} isAnswering={false} isModerate={false} isHost={false}/>);
            expect(screen.queryByTestId('edit-button')).not.toBeInTheDocument();
            expect(screen.queryByTestId('answering')).not.toBeInTheDocument();
        })
        it("render question component - questioner, edit button, isAnswering",async ()=>{
            render(<Question  isModerate={false} question={question} user={{...guest1, guestId:3}} canUploadFile={false} isAnswering={true} isHost={false}/>);
        ...
        it("render question component - upload image enable",async ()=>{
            render(<Question  isModerate={false} question={question} user={{...guest1, guestId:3}} canUploadFile={true} isAnswering={true} isHost={false}/>);
            const elements = screen.queryByTestId('edit-button');
            elements!.click();
        ...
        it("render question component - has 2 images",async ()=>{
            render(<Question isModerate={false} question={{...question, files:[{id:1, filename:'123.png'}, {id:2, filename:'456.png'}]}} user={{...guest1, guestId:3}} canUploadFile={true} isAnswering={true} isHost={false}/>);
        ...
        it("render question component - contains reply but the reply is hidden",async ()=>{
            render(<Question question={{...question, replies:[{...reply, isHide:true}]}} user={guest1} canUploadFile={false} isAnswering={false} isModerate={false} isHost={false}/>);
        ...
        it("render question component - when question is at moderation, but you are not host",async ()=>{
            render(<Question question={question} user={guest1} canUploadFile={false} isAnswering={false} isModerate={true} isHost={false}/>);
    ...
    describe('host',()=>{
        it("render question component - not questioner, but edit button should be displayed, hide button should be displayed",async ()=>{
            render(<Question question={question} user={guest1} canUploadFile={false} isAnswering={false} isModerate={false} isHost={true}/>);
        ...
        it("render question component - when question is at moderation",async ()=>{
            render(<Question question={question} user={guest1} canUploadFile={false} isAnswering={false} isModerate={true} isHost={true}/>);
        ...
        it("render question component - inappropriate question should show display button",async ()=>{
            ...
            render(<Question question={newQuestion} user={guest1} canUploadFile={false} isAnswering={false} isModerate={false} isHost={true}/>);
