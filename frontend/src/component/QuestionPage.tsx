...
const QuestionPage: React.FC = () => {
  ...
  const isHost =
    personInfo?.userId === undefined
      ? false
      : personInfo?.userId === roomInformation?.ownerId;
  ...
  const getPositionOfHTMLelement=(node:HTMLElement)=>{
    if (started) {
      node.scrollIntoView({
        behavior: 'auto',
        block: 'start'
              ...
              <>
                {!(
                  ...
                  <div
                    ...
                    onClick={(e) => {
                      sendEvent();
                      e.currentTarget.parentNode!.childNodes[1].nodeValue='';
                    }}
                  >
            ...
            <div>
              {page === 'main' && (
                ...
                <div style={{ position: 'relative' }}>
                  <FlipMove
                    getPosition={getPositionOfHTMLelement}
                  >
              ...
              {page === 'answered' && (
                <div style={{ position: 'relative' }}>
                  <FlipMove getPosition={getPositionOfHTMLelement}>
